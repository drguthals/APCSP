...
//button variables for accessing in toggle methods
var teacherButton;
var pedagogyButton;

//setter for pedagogy button (called in pedagogy(button))
function pedagogySetter(button){
    pedagogyButton = button;
}

//setter for teacher button (called in toggleTeacherNotes(button))
function teacherSetter(button){
...
function toggleTeacherNotes(button){
    ...
    //setting teacher button
    teacherSetter(button);
    button.value = (button.value == 'Show Teacher Notes')? 'Hide Teacher Notes' : 'Show Teacher Notes';
    
    //handles toggling pedagogy button when teacher button is toggled
    if(pedagogyButton != null && pedagogyButton.value == 'Hide Pedagogy'){
        pedagogyButton.value = 'Show Pedagogy';
    }
    var lessons = document.getElementsByClassName('lesson');
    button.value = (lessons[1].className == 'lesson')? 'Hide Teacher Notes' : 'Show Teacher Notes';
...
// find all lesson lessons in the file, and toggle the notes className for each
function pedagogy(button){
    
    //setting pedagogy button
    pedagogySetter(button);
    button.value = (button.value == 'Show Pedagogy')? 'Hide Pedagogy' : 'Show Pedagogy';
    
    //handles toggling teacher button when pedagogy button is toggled
    if(teacherButton != null && teacherButton.value == 'Hide Teacher Notes'){
        teacherButton.value = 'Show Teacher Notes';
    }
    var lessons = document.getElementsByClassName('lesson');
    button.value = (lessons[1].className == 'lesson')? 'Hide Pedagogy' : 'Show Pedagogy';
    
    
    for(var i=0; i<lessons.length; i++){
        lessons[i].className = (lessons[i].className == 'lesson')? 'lesson pedagogyNotes' : 'lesson';
    }
}
