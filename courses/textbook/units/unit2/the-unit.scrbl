...
@(include-lesson (lib "APCSP/lessons/Intro-to-Racket-and-Numbers/lesson/lesson-long.scrbl"))

@(include-lesson (lib "APCSP/lessons/Circles-of-Evaluation/lesson/lesson-long.scrbl"))
...
@(include-lesson (lib "APCSP/lessons/Creating-Images/lesson/lesson-long.scrbl"))
